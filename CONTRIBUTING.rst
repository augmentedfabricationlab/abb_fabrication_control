...
1. Fork `the repository <https://github.com/augmentedfabricationlab/abb_fabrication_control>`_ and clone the fork.
...
When `reporting a bug <https://github.com/augmentedfabricationlab/abb_fabrication_control/issues>`_
please include:
...
`Github <https://github.com/augmentedfabricationlab/abb_fabrication_control/issues>`_. If you are proposing a feature:
